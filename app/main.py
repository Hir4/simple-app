...
from validation_models import AccountModel, WeatherModel, HttpResult
...
async def validation_exception_handler(request, exc):
    return JSONResponse(
        content=jsonable_encoder(HttpResult(detail={"message": exc.errors(), "body": exc.body})),
...
async def get_accounts_by_name(account_name: str, response: Response) -> HttpResult:
    ...
    return HttpResult(detail={"message": result}) #TODO: retornar o model em todos endpoints
