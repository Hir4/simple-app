# TODO: dependabot
# TODO: usar o injetor de dependencias 
#do fastapi para injetar conexão com o banco de dados
...
# curl -d '{"latitude": -23.5475, "longitude": -46.6361, "start_date": "2023-07-28", 
# "end_date": "2023-08-02"}' -H "Content-Type: application/json" -X POST  http://localhost:8080/historical_weather/

# curl -d '{"username":"fael", "password": "123"}' 
# -H "Content-Type: application/json" -X POST http://localhost:8080/create_account/
